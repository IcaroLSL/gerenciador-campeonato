    ...
    <div class="p-4 space-y-4">
        ...
        switch ($userType) {
            case 'Administrador':
                ...
                <li class="p-4 border border-gray-300 rounded hover:bg-gray-100 text-center hover:cursor-pointer"><a href="CadastroJogador.php"><i class="fas fa-plus-circle"></i> Cadastrar campeonato</a></li>
                <li class="p-4 border border-gray-300 rounded hover:bg-gray-100 text-center hover:cursor-pointer"><a href="CadastroUsuario.php"><i class="fas fa-users"></i> Cadastrar Time</a></li>
                <li class="p-4 border border-gray-300 rounded hover:bg-gray-100 text-center hover:cursor-pointer"><a href="CadastroUsuario.php"><i class="fas fa-user-tie"></i> Cadastrar Treinadores</a></li>
                <li class="p-4 border border-gray-300 rounded hover:bg-gray-100 text-center hover:cursor-pointer"><a href="CadastroUsuario.php"><i class="fas fa-user"></i> Cadastrar Jogadores</a></li>';
                break;
            case 'Treinador':
                echo '
